...
echo "============================================================"
echo " BELA STOCK 3.0 - FINAL SECOND PASS / ADVERSARIAL AUDIT"
echo " HOST=$(hostname)"
echo " DATE=$(date -Is)"
echo "============================================================"
...
if(!p.dependencies?.['@fastify/rate-limit']) process.exitCode=30;
NODE
if grep -RqsE 'rateLimit|rate-limit' "$SITE/src"; then echo "AUTH_RATE_LIMIT_CODE=PRESENT"; else echo "AUTH_RATE_LIMIT_CODE=ABSENT"; exit 31; fi
